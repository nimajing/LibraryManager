...
// It is called through the login state when the user presses the register button
// It is also called through the main menu when the user presses the register button
